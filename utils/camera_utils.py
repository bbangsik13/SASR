...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  ...
                  depth_image=depth, mask=mask, bounds=cam_info.bounds, focalx=cam_info.focalx, focaly=cam_info.focaly, width=cam_info.width, height=cam_info.height,min_kernel=args.min_kernel,max_kernel=args.max_kernel)
