...
from utils.laplacian import argmax_LoG_sigma

class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 image_name, uid, trans=np.array([0.0, 0.0, 0.0]),
                 scale=1.0, data_device = "cuda", depth_image = None, mask = None, bounds=None, focalx=None, focaly=None, width=None, height=None,min_kernel=1, max_kernel=15):
